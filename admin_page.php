...
if($op == 'edit') {
    $id             = $_GET['id'];
    $sql1           = "select * from data_penyewa where id = '$id'";
...
if($op == 'delete'){
    $id         = $_GET['id'];
    $sql1       = "delete from data_penyewa where id = '$id'";
    $q1         = mysqli_query($koneksi,$sql1);
    if($q1){
...
if(isset($_POST['submit'])) {
    ...
    if($nama && $alamat && $no_hp && $mobil && $jangka_waktu && $jaminan) {
        if($op == 'edit') {
            $sql1       = "update data_penyewa set nama = '$nama', alamat = '$alamat', no_hp = '$no_hp', mobil = '$mobil', jangka_waktu = '$jangka_waktu', jaminan = '$jaminan' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if($q1) {
...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Bungee&family=Comfortaa:wght@300&family=Silkscreen&display=swap');
    ...
    <title>Rental Mobil | Admin Page</title>
</head>
<body>
    <div class="judul bg-info" sty>
            ...
            <div class="card-body">
                ...
                ?>
                    <div class="alert alert-warning" role="alert">
                        ...
                        <?php header("refresh:5;url=admin_page.php"); ?>
                    </div>
                <?php
                    }
                ?>
            ...
            <div class="card-body">
                <table class="table">
                    <thead>
                        ...
                        <tbody>
                            <?php
                                $sql2   = "select * from data_penyewa order by id asc";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td scope="row"><?php echo $jangka_waktu ?></td>
                                    <td scope="row"><?php echo $jaminan ?></td>
                                    <td scope="row">
                                        <a href='admin_page.php?op=edit&id=<?php echo $id ?>' class="link-dark fs-5 me-3"><img src="icon/pencil-fill.svg" alt="Edit" class="me-2"></a>
                                        <a href="admin_page.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Apakah anda ingin menghapus data ini?')"><img src="icon/trash.svg" alt="Delete"></a>
                                    </td>
                                </tr>
